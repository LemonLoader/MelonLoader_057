...
{
    public abstract class MonkiiPreferences_Entry
    {
        ...
        public MonkiiPreferences_Category Category { get; internal set; }
        ...
        public readonly MonkiiEvent<object, object> OnEntryValueChangedUntyped = new MonkiiEvent<object, object>();
        ...
        [Obsolete("Please use the OnEntryValueChangedUntyped MonkiiEvent instead.")]
        public event Action OnValueChangedUntyped;
    }

    public class MonkiiPreferences_Entry<T> : MonkiiPreferences_Entry
    {
        private T myValue;
        public T Value
        {
        ...
        public readonly MonkiiEvent<T, T> OnEntryValueChanged = new MonkiiEvent<T, T>();

        [Obsolete("Please use the OnEntryValueChanged MonkiiEvent instead.")]
