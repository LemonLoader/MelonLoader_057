...
namespace MonkiiLoader
{
    ...
    public class MonkiiModInfoAttribute : MonkiiInfoAttribute
    {
        ...
        [Obsolete("MonkiiLoader.MonkiiPluginInfoAttribute is Only Here for Compatibility Reasons. Please use MonkiiLoader.MonkiiInfo instead.")]
        public MonkiiModInfoAttribute(Type type, string name, string version, string author, string downloadLink = null) : base(type, name, version, author, downloadLink) { }
    }
}