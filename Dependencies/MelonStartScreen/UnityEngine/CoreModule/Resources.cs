...
namespace MonkiiUnityEngine
{
    internal class Resources
    {
        ...
        public unsafe static IntPtr GetBuiltinResource(Il2CppSystem.Type type, string path)
        {
            ...
            MonkiiDebug.Msg("Calling runtime_invoke for GetBuiltinResource");
            IntPtr objectPointer = UnityInternals.runtime_invoke(m_GetBuiltinResource, IntPtr.Zero, ptr, ref returnedException);
            MonkiiDebug.Msg("returnedException: " + returnedException + ", objectPointer: " + objectPointer);
        ...
        {
            MonkiiDebug.Msg("GetBuiltinResource<T>");
